/**
 * Quick Settings — user preferences for AI pipeline and map behavior.
 * Desktop defaults are local-first: browser model on, paid cloud providers off.
 *
...
const DEFAULTS: AiFlowSettings = {
  browserModel: isDesktopRuntime(),
  cloudLlm: !isDesktopRuntime(),
  mapNewsFlash: true,
